...
> [!IMPORTANT]
> Travel fund requests should be reasonable and cost-effective. Please make travel choices that support your safety and well-being so you arrive ready to participate, while being mindful of the limited budget and ensuring that others can also benefit from it. For example: book early, select standard accommodation, choose the lowest practical airfare, and take advantage of any available conference or group rates. When in doubt, feel free to ask for advice in your request. The CPC may choose to only offer partial funding corresponding to the estimated cost of reasonable and cost-effective travelling.

...
Adam: I PR’d a list of program ideas for what we’d like to provide for member projects (https://github.com/nodejs/bootstrap/blob/HEAD/meetings/2018-10-13.md) - we need to flesh these out enough to be able to fit it under the right TLC.

...
1. Project files an issue in this repository requesting its charter to be reviewed by the CPC
1. Project graduates from incubation by a pull request closing the charter review issue and adding it to the README.md file at its appropriate initial stage.

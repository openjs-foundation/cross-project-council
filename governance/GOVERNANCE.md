...
Pull requests that change CPC governance (including changes to [authority delegation to Collaboration Spaces](./COLLABORATION_NETWORK.md#authority-delegation)) or the [stage of a project](../PROJECT_PROGRESSION.md#project-stages) must meet the following conditions in addition to the ones listed for regular PRs:

...
|---|---|---|
| Technical writer's (audit, update, publish of content) | 7000.00 USD | We understand that this technical work will be complex and require a lot of iteration, communication and technical understanding of the Node.js project. Hence we believe the writer should be paid accordingly |
